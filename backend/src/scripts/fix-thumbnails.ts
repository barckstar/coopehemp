...
const PRODUCT_IMAGES: Record<string, { thumbnail: string; images: string[] }> = {
  ...
  "Aceite de CBD 500mg":              { thumbnail: "https://placehold.co/800x600/14532d/white?text=CBD+500mg",          images: ["https://placehold.co/800x600/166534/white?text=CBD500+1",  "https://placehold.co/800x600/15803d/white?text=CBD500+2"] },
  "Aceite de CBD 1000mg":             { thumbnail: "https://placehold.co/800x600/14532d/white?text=CBD+1000mg",         images: ["https://placehold.co/800x600/166534/white?text=CBD1000+1", "https://placehold.co/800x600/15803d/white?text=CBD1000+2"] },
...
export default async function fixThumbnails({ container }: ExecArgs) {
  ...
  const { products } = await productService.listProducts({}, { take: 50, relations: ["images"] })
  let updated = 0
